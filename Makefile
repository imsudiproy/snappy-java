...
win-armv7: jni-header
	...
	./docker/dockcross-windows-armv7 -a $(DOCKER_RUN_OPTS) bash -c 'make clean-native native CROSS_PREFIX=//usr/xcc/armv7-w64-mingw32-cross/bin/armv7-w64-mingw32- OS_NAME=Windows OS_ARCH=armv7'
